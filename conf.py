...
latex_documents = [
    (master_doc, 'methQC.tex', 'methQC Documentation',
...
man_pages = [
    (master_doc, 'methQC', 'methQC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'methQC', 'methQC Documentation',
     author, 'methQC', 'One line description of project.',
     'Miscellaneous'),
]
