...
If you are new to DNA methylation analysis, we recommend reading through this [introduction](https://github.com/FoxoTech/methylprep/blob/feature/v1.5.5-docs/docs_dev/introduction/introduction.md) from the `methylprep` documentation. Otherwise, you are ready to use `methylcheck` to:
...
<!-- add links to different tutorial pages -->

<!-- update link to introduction when docs make it to master branch of methylprep -->